...
public class Provider extends ContentProvider {
    ...
    /**
     * Provider authority: com.aware.plugin.ChuIO1.provider.ChuIO1
     */
    public static String AUTHORITY = "com.aware.plugin.ChuIO1.provider.ChuIO1";
    private static final int CHUIO1 = 1; //CHUIO1
    private static final int CHUIO1_ID = 2;
    public static final String DATABASE_NAME = Environment.getExternalStorageDirectory() + "/AWARE/ChuIO1.db";
